    ...
    'colors': {
        'aqua': {
            'color-50-aqua': '#f9fdfd', /* #F9FDFD
                                        ...
                                        Extended palette */
            'color-100-aqua': '#d6f0f1', /* #D6F0F1
                                        
                                        Extended palette */
            'color-200-aqua': '#a9d8da', /* #A9D8DA
                                        
                                        Extended palette */
            'color-300-aqua': '#7ec4c7', /* #7EC4C7
                                        
                                        Extended palette */
            'color-400-aqua': '#37bcc2', /* #37BCC2
                                        
                                        Extended palette */
            'color-500-aqua': '#489a9d', /* #489A9D
                                        
                                        Extended palette */
            'color-600-aqua': '#377a7d', /* #377A7D
                                        
                                        Extended palette */
            'color-700-aqua': '#2c5b5d', /* #2C5B5D
                                        
                                        Extended palette */
            'color-800-aqua': '#1f3c3d', /* #1F3C3D
                                        
                                        Extended palette */
            'color-900-aqua': '#152426', /* #152426
                                        
                                        Extended palette */
        },
        'fuchsia': {
            'color-50-fuchsia': '#fff5fe', /* #FFF5FE
                                        
                                        Extended palette */
            'color-100-fuchsia': '#ffe9fc', /* #FFE9FC
                                        
                                        Extended palette */
            'color-200-fuchsia': '#f7c9f1', /* #F7C9F1
                                        
                                        Extended palette */
            'color-300-fuchsia': '#e09ed9', /* #E09ED9
                                        
                                        Extended palette */
            'color-400-fuchsia': '#d47acc', /* #D47ACC
                                        
                                        Extended palette */
            'color-500-fuchsia': '#bd58b7', /* #BD58B7
                                        
                                        Extended palette */
            'color-600-fuchsia': '#973b93', /* #973B93
                                        
                                        Extended palette */
            'color-700-fuchsia': '#752671', /* #752671
                                        
                                        Extended palette */
            'color-800-fuchsia': '#4d124a', /* #4D124A
                                        
                                        Extended palette */
            'color-900-fuchsia': '#320630', /* #320630
                                        
                                        Extended palette */
        },
        'secondary': {
            'color-secondary': '#00628b', /* Text links and action items like icons and cancel buttons. */
            'color-secondary-lightest': '#d9e7ee', /* #D9E7EE
                                        Secondary button selected fill.  */
            'color-secondary-lighter': '#99c0d1', /* #99C0D1
                                        
                                        Secondary button pressed.
                                        The contrast hover color for links, toggles radio, checkboxes and other action items.  */
            'color-secondary-light': '#66a1ba', /* #66A1BA
                                        
                                        The contrast color for links, links and other action items.  */
            'color-secondary-dark': '#003b54', /* #003B54
        ...
        'red': {
            'color-50-red': '#fffbfa', /* #FFFBFA
                                        
                                        Extended palette */
            'color-100-red': '#ffe5e0', /* #FFE5E0
                                        
                                        Extended palette */
            'color-200-red': '#fec3b6', /* #FEC3B6
                                        
                                        Extended palette */
            'color-300-red': '#fe8f7b', /* #FE8F7B
                                        
                                        Extended palette */
            'color-400-red': '#ff6652', /* #FF6652
                                        
                                        Extended palette */
            'color-600-red': '#da021c', /* #DA021C
                                        
                                        Extended palette */
            'color-700-red': '#a20713', /* #A20713
                                        
                                        Extended palette */
            'color-800-red': '#800c0f', /* #800C0F
                                        
                                        Extended palette */
            'color-900-red': '#560f08', /* #560F08
                                        
                                        Extended palette */
            'color-500-red': '#ff1822', /* #FF1822
                                        
                                        Extended palette */
        },
        'accent': {
            'color-accent-one': '#ffc600', /* #FFC600
            ...
            'color-accent-two': '#ff1822', /* #FF1822
        ...
        'grayscale': {
            ...
            'color-50-gray': '#f8f8f8', /* #F8F8F8 */
            'color-100-gray': '#ededed', /* #EDEDED
                                        Backgrounds, strokes, dividers, Inactive backgrounds */
            'color-200-gray': '#cccccc', /* #CCCCCC
                                        
                                        Default strokes */
            'color-300-gray': '#b3b3b3', /* #B3B3B3
                                        
                                        Inactive Text
                                        Inactive strokes */
            'color-400-gray': '#949494', /* #949494 */
            'color-500-gray': '#7f7f7f', /* #7F7F7F */
            'color-logo-gray': '#63666a', /* #63666A
                                        
                                        Gray used in the ZINNIA logo and logotype */
            'color-600-gray': '#676767', /* #676767
                                        
                                        Use for Section Labels and 
                                        Accents */
            'color-700-gray': '#4d4d4d', /* #4D4D4D */
            'color-800-gray': '#313131', /* #313131 */
            'color-900-gray': '#212121', /* #212121
        ...
        'yellow': {
            'color-50-yellow': '#fffcf8', /* #FFFCF8
                                        
                                        Extended palette */
            'color-100-yellow': '#fcf0dc', /* #FCF0DC
                                        
                                        Extended palette */
            'color-200-yellow': '#ffe3ab', /* #FFE3AB
                                        
                                        Extended palette */
            'color-300-yellow': '#ffd576', /* #FFD576
                                        
                                        Extended palette */
            'color-500-yellow': '#fcaf0e', /* #FCAF0E
                                        
                                        Extended palette */
            'color-600-yellow': '#e89510', /* #E89510
                                        
                                        Extended palette */
            'color-700-yellow': '#c57402', /* #C57402
                                        
                                        Extended palette */
            'color-800-yellow': '#9d5400', /* #9D5400
                                        
                                        Extended palette */
            'color-900-yellow': '#703800', /* #703800
        ...
        'chip': {
            ...
            'chip-primary-border': '#cccccc', 
            'chip-primary-text': '#212121', 
            'chip-primary-icon': '#212121', 
            'chip-primary-hover-fill': '#ffead9', 
            'chip-primary-hover-text': '#212121', 
            'chip-primary-hover-border': '#ff7500', 
            'chip-primary-selected-fill': '#ffc899', 
            'chip-primary-selected-text': '#212121', 
            'chip-primary-selected-border': '#ff7500', 
            'chip-primary-inactive-fill': '#ededed', 
            'chip-primary-inactive-border': '#b3b3b3', 
            'chip-primary-inactive-text': '#b3b3b3', 
        },
        'toggle': {
            'toggle-default-fill': '#676767', 
            'toggle-inactive-fill': '#b3b3b3', 
            'toggle-selected-fill': '#ff7500', 
            'toggle-selected-inactive-fill': '#ffead9', 
            'toggle-default-indicator': '#ffffff', 
            'toggle-inactive-indicator': '#ededed', 
            'toggle-default-icon': '#ffffff', 
            'toggle-inactive-icon': '#ededed', 
            'toggle-contrast-default-fill': '#676767', 
            'toggle-contrast-selected-fill': '#ff7500', 
            'toggle-contrast-inactive-indicator': '#949494', 
            'toggle-contrast-default-indicator': '#ffffff', 
            'toggle-contrast-selected-inactive-indicator': '#ffac66', 
            'toggle-contrast-default-icon': '#ffffff', 
        ...
        'status-surface': {
            ...
            'status-hover-contrast-border': '#ffc600', 
            'status-information-border': '#005fed80', 
            'status-information-border-alt': '#005fed', 
            'status-success-border': '#00876280', 
            'status-pending-border': '#ac009180', 
            'status-warning-border': '#c3520080', 
            'status-error-border': '#db004f80', 
            'status-information-light': '#f2f7fe', 
            'status-success-light': '#f2f9f7', 
            'status-pending-light': '#fbf2f9', 
            'status-warning-light': '#fcf6f2', 
            'status-error-light': '#fdf2f6', 
            'status-success-border-alt': '#007b5a', 
            'status-pending-border-alt': '#ac0091', 
        ...
        'button-contrast': {
            ...
            'button-contrast-inactive-border': '#676767', 
            'button-contrast-inactive-fill': '#313131', 
            'button-contrast-selected-text': '#212121', 
            'button-contrast-selected-border': '#ffffff', 
            'button-contrast-selected-fill': '#ffffff', 
            'button-contrast-pressed-text': '#ffffff', 
            'button-contrast-pressed-border': '#ffffff', 
            'button-contrast-pressed-fill': '#4d4d4d', 
            'button-contrast-hover-text': '#ffffff', 
            'button-contrast-hover-border': '#ffffff', 
            'button-contrast-hover-fill': '#313131', 
            'button-contrast-text': '#ffffff', 
            'button-contrast-border': '#ffffff', 
            'button-contrast-fill': '#212121', 
        },
        'button-primary': {
            'button-primary-inactive-text': '#b3b3b3', 
            'button-primary-inactive-border': '#b3b3b3', 
            'button-primary-inactive-fill': '#ededed', 
            'button-primary-selected-text': '#212121', 
            'button-primary-selected-border': '#ff7500', 
            'button-primary-selected-fill': '#ff7500', 
            'button-primary-pressed-text': '#212121', 
            'button-primary-pressed-border': '#ff7500', 
            'button-primary-pressed-fill': '#ffc899', 
            'button-primary-hover-text': '#212121', 
            'button-primary-hover-border': '#ff7500', 
            'button-primary-hover-fill': '#ffead9', 
        ...
        'element-radio-checkbox-contrast': {
            ...
            'element-contrast-background-hover-fill': '#212121', 
            'element-contrast-background-selected-fill': '#212121', 
            'element-contrast-background-inactive-fill': '#313131', 
            'element-contrast-background-selected-inactive-fill': '#212121', 
            'element-contrast-indicator-selected': '#ff7500', 
            'element-contrast-selected-inactive-': '#994600', 
            'element-contrast-border-default': '#ffffff', 
            'element-contrast-border-hover': '#ffc600', 
        ...
        'base-border': {
            ...
            'border-secondary-color': '#00628b', 
            'border-light': '#ededed', 
            'border-subtle': '#cccccc', 
            'border-bold': '#b3b3b3', 
            'border-bolder': '#676767', 
            'border-dark': '#313131', 
            'border-darker': '#212121', 
        },
        'base-text': {
            'text-primary': '#212121', 
        ...
        'states-inactive': {
            'inactive-text': '#b3b3b3', 
            'inactive-text-contrast': '#676767', 
            'inactive-icon': '#b3b3b3', 
            'inactive-icon-contrast': '#676767', 
            'inactive-fill': '#ededed', 
            'inactive-fill-contrast': '#313131', 
            'inactive-text-link': '#b3b3b3', 
            'inactive-contrast-text-link': '#676767', 
        },
        'states-hover': {
            'hover-primary-border': '#ffc600', 
            'hover-primary-fill': '#ffffff', 
            'hover-primary-fill-alt': '#ffead9', 
            'hover-secondary-border': '#003b54', 
            'hover-secondary-contrast-border': '#99c0d1', 
            'hover-secondary-fill': '#ffffff', 
            'hover-text-link': '#003b54', 
            'hover-contrast-text-link': '#99c0d1', 
            'hover-icon-action': '#003b54', 
        },
        'states-selected': {
            'selected-primary-border': '#ff7500', 
            'selected-primary-fill': '#ffc899', 
            'selected-primary-fill-alt': '#ffead9', 
            'selected-secondary-border': '#00628b', 
            'selected-secondary-contrast-border': '#66a1ba', 
            'selected-secondary-fill': '#66a1ba', 
        ...
        'fields-border': {
            'field-border-default': '#cccccc', 
            'field-border-hover': '#ffc600', 
            'field-border-active': '#ff7500', 
            'field-border-success': '#007b5a', 
