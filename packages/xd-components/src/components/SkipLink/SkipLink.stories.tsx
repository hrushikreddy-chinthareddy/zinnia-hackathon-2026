...
const meta: Meta<typeof SkipLink> = {
  ...
  parameters: {
    docs: {
      description: {
        component: 'A skip link component for accessibility. Hidden by default, becomes visible when focused via keyboard navigation. Allows users to skip directly to main content.',
      },
    },
  },
  argTypes: {
  ...
  render: (args) => (
    <div>
      ...
      <div style={{ padding: '20px', border: '1px solid #ccc', marginTop: '20px' }}>
        <p>Press Tab to focus the skip link above, then press Enter to skip to main content below.</p>
      </div>
      <main id="demo-main" style={{ padding: '20px', backgroundColor: '#f5f5f5', marginTop: '20px' }}>
        <h2>Main Content</h2>
        <p>This is the main content area that the skip link will jump to.</p>
        <p>The skip link helps keyboard users bypass navigation and get directly to the main content.</p>
      </main>
    </div>
  ),
  parameters: {
