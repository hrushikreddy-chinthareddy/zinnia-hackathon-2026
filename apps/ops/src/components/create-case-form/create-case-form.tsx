...
const CreateCaseForm = ({
    ...
    const isNewLayout =
        caseType === CaseType.AddressChange || caseType === CaseType.ReReg;
    ...
    return (
        <>
            <div className="rounded bg-white p-4 shadow-sm">
                <div
                    className={`flex w-full gap-4 self-center  ${
                        isNewLayout ? 'flex-col' : ''
                    }`}
                >
                    <div className="flex gap-4 self-center xs:flex-col lg:flex-row">
                        <SelectSimple
                            ...
                            label={
                                t('caseRenewal.caseCreate.caseType') as string
                            }
                            className={
                                isNewLayout
                                    ? 'md:min-w-[333px]'
                            ...
                            onChange={(value) =>
                                onCaseTypeChange(value as CaseType)
                            }
                            options={[
                                ...(shouldShowReg60Case
                                    ? [
                                    ...
                                    : []),
                                {
                                    label: t('caseRenewal.caseCreate.oft'),
                                    value: CaseType.Oft,
                                },
                                {
                                    label: t('caseRenewal.caseCreate.renewal'),
                                    value: CaseType.Renewal,
                                },
                                {
                                    label: t('caseRenewal.caseCreate.rmd'),
                                    value: CaseType.Rmd,
                                },
                                {
                                    label: t(
                                ...
                                {
                                    label: t('caseRenewal.caseCreate.ssw'),
                                    value: CaseType.SSW,
                                },
                                {
                                    label: t(
                                        'caseRenewal.caseCreate.addressChange'
                                    ),
                                    value: CaseType.AddressChange,
                                },
                                {
                                    label: t('caseRenewal.caseCreate.reReg'),
                                    value: CaseType.ReReg,
                                },
                            ]}
                            placeholder={
                                t(
                        ...
                        <SelectSimple
                            ...
                            options={clientIds.map((cId) => {
                                return {
                                    label: `${
                                        getCarrierNameByClientId(cId, true) ||
                                        cId?.toUpperCase()
                                    }`,
                        ...
                        {isNewLayout && (
                            <div className="flex gap-4">
                                <ButtonGroup
                                    ...
                                    toggle={(value) =>
                                        setSearchByOption(value as SearchKeys)
                                    }
                                    labels={searchByLabels(t)}
                                    groupLabel={t(
                                        'dashboard.search.searchKeyType'
                                    )}
                                />
                                {searchByOption ===
                                SearchKeys.DocumentNumber ? (
                                    ...
                                    <Field
                                        label={
                                            t(
                                                'caseRenewal.caseCreate.policyNumber'
                                            ) as string
                                        }
                                        className={`${
                                            isNewLayout
                                        ...
                                        onChange={(event) =>
                                            setSearchBy(
                                                xss(event.target.value),
                                                SearchKeys.PolicyNumber
                                            )
                                        }
                                        placeholder={
                                            t(
                                                'caseRenewal.caseCreate.policyNumberPlaceholder'
                                            ) as string
                                        }
                                        size={FieldSize.Small}
                                        type={FieldType.BaseActive}
                    ...
                    <div className="xs:self-center">
                        ...
                        >
                            {caseType === CaseType.Renewal
                                ...
                                : t('caseRenewal.caseCreate.search')}
                        </Button>
                    </div>
                </div>
                <div>
