...
describe('ProgressBar', () => {
    it('> renders ProgressBar component with correct values', () => {
        ...
        render(<ProgressBar compareValue={compareValue} total={total} label={label} />);

        expect(screen.getByTestId(ProgressBarTest.PROGRESSBAR)).toBeInTheDocument();
        expect(screen.getByTestId(ProgressBarTest.COMPAREVALUE)).toBeInTheDocument();
