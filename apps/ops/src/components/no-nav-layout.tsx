...
const NoNavLayout: React.FC<NoNavLayoutProps> = ({ fullHeight, children, displayTopNavBar = true }: NoNavLayoutProps) => {
    ...
    return (
        <div className={`${fullHeight ? 'h-full' : ''}`}>
            ...
            <div className="mx-4 mb-8 mt-16 sm:mt-6 md:mx-6 md:mt-16 lg:mx-8 [@media(min-width:1194px)]:mx-auto [@media(min-width:1194px)]:max-w-[1130px]">
                {children}
            </div>
        </div>
    );
