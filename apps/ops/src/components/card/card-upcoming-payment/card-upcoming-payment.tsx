...
const UpcomingPaymentCard = ({
    ...
    inactiveHeaderText,
    inactiveIcon = (
        <PaymentIcon width={50} height={50} className="text-gray-300" />
    ),
    paymentText,
    paymentDate,
    paymentDateText,
    ...
    const paymentAmount =
        autopayAmount +
        (additionalCharges?.reduce((a, b) => a + (b.amount || 0), 0) || 0);
                ...
                (hasUpcomingPayment || displayCardWithZeroAmount) ? (
                    <>
                        ...
                        >
                            ...
                            <FieldData
                                label={`${
                                    paymentDateText || t('paymentDateText')
                                } ${activityPaymentDate}`}
                            >
                                    ...
                                    >
                                        <PiiWrapper>
                                            {toTitleCase(
                                                ...
                                                t('endingIn') +
                                                bankDetails?.accountNumber?.substring(
                                                    bankDetails?.accountNumber
                                                        .length - 4
                                                )}
                                        </PiiWrapper>
