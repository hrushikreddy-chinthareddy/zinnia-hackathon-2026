...
export default function TasksTable({ t, config, tasks }: TasksTableProps) {
    const limit = 5;
                ...
                <Table>
                    <TableHeader>
                        <TableRow>
                            <TableHeaderCell>
                                <Label>
                                    {t('tasksListing.tableColumns.status')}
                                </Label>
                            </TableHeaderCell>
                            <TableHeaderCell>
                                <Label>
                            ...
                            <TableHeaderCell>
                                <Label>
                                    {t(
                                        'tasksListing.tableColumns.statusDuration'
                                    )}
                                </Label>
                            </TableHeaderCell>
                            <TableHeaderCell>
                                <Label>
                                    {t('tasksListing.tableColumns.dateTime')}
                                </Label>
                            </TableHeaderCell>
                            <TableHeaderCell>
                                <Label>
                                    {t('tasksListing.tableColumns.userId')}
                                </Label>
                            </TableHeaderCell>
                            <TableHeaderCell>
                                <Label>
                                    {t('tasksListing.tableColumns.actions')}
                                </Label>
                            </TableHeaderCell>
                        </TableRow>
                    </TableHeader>
