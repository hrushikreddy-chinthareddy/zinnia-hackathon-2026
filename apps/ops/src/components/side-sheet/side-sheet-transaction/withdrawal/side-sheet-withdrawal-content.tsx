        ...
        <>
            <section>
                ...
                <Typography variant={TypographyVariant.H4}>
                    {t('policy.history.withdrawalSidesheet.detailsTitle', { transactionType: transactionTypeLabel })}
                </Typography>
                                ...
                                (payee, index: Key) => (
                                    <tr role="row" key={index} className="flex">
                                        ...
                                        <td role="cell" className="w-[30%] content-center border-b-1 border-gray-200 px-3 py-2 text-right">
                                            ...
                                            <Typography variant={TypographyVariant.BodySm}>{percentFormatify(payee.allocationPercentage, { isInteger: true})}</Typography>
                                        </td>
                                        <td
                                            role="cell"
