...
const BpmErrorState = ({ children, onCancel, onContinue, setViewState, transaction, validationResults }: BpmErrorStateProps) => {
    const { t } = useTranslation(TranslationFiles.COMMON, { keyPrefix: 'people.sideSheet.states.bpmError' });
        ...
        <div className="flex flex-col">
            ...
            <div className="flex flex-col gap-6 px-8">
                <div className="flex flex-col gap-6 rounded border-2 border-gray-200 p-6">
                    ...
                    >
                        {t('edit', {
                            transaction: defaultT(`people.sideSheet.transactions.${transaction}`).toLocaleLowerCase(),
                        })}
                    </NavElement>
                    {children}
                </div>
