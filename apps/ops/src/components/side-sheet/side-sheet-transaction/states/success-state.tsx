...
const SuccessState = ({ caseId, transactionType, isNigo, onCancel }: SuccessStateProps) => {
    const { t } = useTranslation(TranslationFiles.COMMON, { keyPrefix: 'transactions.states.success' });
