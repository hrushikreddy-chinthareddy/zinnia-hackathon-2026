    ...
    if (!bankDetails) {
        return (
            <CardInfo
                ...
                subtitle=""
                cta={{
                    action: () => sideSheet.handleOpen(false),
                    text: t('sideSheet.bankingDetails.close'),
                }}
            />
        );
    }
    ...
    return (
        <div className="p-8">
            <Typography variant={TypographyVariant.H2}>
                {t('sideSheet.bankingDetails.heading')}
            </Typography>
            <div className="mt-8 grid grid-cols-2 gap-8">
                <div className="flex flex-col">
                    <Label
                        label={t('sideSheet.bankingDetails.bankName')}
                ...
                <div className="flex flex-col">
                    <Label
                        label={t('sideSheet.bankingDetails.accountType')}
                        variant={LabelVariant.FieldLabel}
                    />
                    <Typography variant={TypographyVariant.BodySm}>
                        <PiiWrapper>
                            {getBankAccountType(bankDetails.accountType, t) ||
                                DEFAULT_ERROR_STRING}
                        </PiiWrapper>
                    </Typography>
                </div>
                <div className="flex flex-col">
                    <Label
                        label={t('sideSheet.bankingDetails.routingNumber')}
                        variant={LabelVariant.FieldLabel}
                    />
                    <Typography variant={TypographyVariant.BodySm}>
                ...
                <div className="flex flex-col">
                    <Label
                        label={t('sideSheet.bankingDetails.accountNumber')}
                        variant={LabelVariant.FieldLabel}
                    />
                    <Typography variant={TypographyVariant.BodySm}>
                        <PiiWrapper>
                            {t('sideSheet.bankingDetails.endingIn', {
                                accountNumber,
                            })}
                        </PiiWrapper>
                    </Typography>
                ...
                <div className="flex flex-col">
                    <Label
                        label={t('sideSheet.bankingDetails.nameOnAccount')}
                        variant={LabelVariant.FieldLabel}
                    />
                    <Typography variant={TypographyVariant.BodySm}>
                        <PiiWrapper>
                            {toTitleCase(bankDetails.nameOnAccount)}
                        </PiiWrapper>
                    </Typography>
                </div>
            </div>
