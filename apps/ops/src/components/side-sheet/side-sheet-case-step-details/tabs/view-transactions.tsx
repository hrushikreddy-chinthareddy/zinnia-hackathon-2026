...
export function ViewTransactions({ stepAdditionalData, prop }: ViewTransactionsProps) {
    ...
    const programs = transactionEntity ? transactionEntity?.entity?.stopPrograms?.[prop] : [];
