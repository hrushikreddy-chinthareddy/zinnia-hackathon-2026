...
describe('##ViewTransactions for uncashed programs', () => {
    ...
    it('#should render the uncashed transactions component', () => {
        ...
        expect(
            screen.getByText('transactionListing.uncashedTransactions')
        ).toBeInTheDocument();
        expect(
            screen.getByTestId('contract-heading-551007004')
        ).toBeInTheDocument();
        expect(
            screen.getByTestId(
                'trans-check-number-2912c073-b748-4512-96e8-a403f818de38'
            )
        ).toBeInTheDocument();
        expect(
            screen.getByTestId(
                'trans-amount-2912c073-b748-4512-96e8-a403f818de38'
            )
        ).toBeInTheDocument();
        expect(
            screen.getByTestId(
                'trans-check-date-2912c073-b748-4512-96e8-a403f818de38'
            )
        ).toBeInTheDocument();
    });
    ...
    it('#should render the uncashed transactions component', () => {
        ...
        expect(screen.getByTestId('uncashed-in-progress')).toBeInTheDocument();
        expect(
            screen.getByText('transactionListing.identificationInProgress')
        ).toBeInTheDocument();
    });
});

describe('##ViewTransactions for systematic programs', () => {
    let consoleErrorSpy: jest.SpyInstance;
