    ...
    return (
        <div className="my-4 grid grid-cols-2 gap-4">
            ...
            <Field
                ...
                onChange={(e) =>
                    onDataChange('claimsAndCredits', e.target.value)
                }
                size={FieldSize.Small}
                type={FieldType.BaseActive}
            ...
            <Field
                ...
                onChange={(e) =>
                    onDataChange('otherIncomeAndPensions', e.target.value)
                }
                size={FieldSize.Small}
                type={FieldType.BaseActive}
            ...
            <Field
                ...
                onChange={(e) =>
                    onDataChange('otherDeductions', e.target.value)
                }
                size={FieldSize.Small}
                type={FieldType.BaseActive}
