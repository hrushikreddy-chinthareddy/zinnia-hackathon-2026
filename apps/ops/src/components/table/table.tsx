...
export interface TableProps extends AgGridReactProps {
    ...
    rowData?: any[];
    rowSelectHandler?: (
        ref: RefObject<AgGridReact<any>>,
        e: SelectionChangedEvent<any, any>
    ) => void;
...
export default function DepTable(props: TableProps): JSX.Element {
    ...
    const gridCustomStyles = customComparisonTableStyles
            ...
            <div className={clsx('ag-theme-alpine', gridCustomStyles)}>
                <AgGridReact
                    ...
                    onSelectionChanged={(e) =>
                        rowSelectHandler && rowSelectHandler(gridRef, e)
                    }
                    ref={gridRef}
                    rowClass={rowClass}
                    rowClassRules={rowClassRules}
