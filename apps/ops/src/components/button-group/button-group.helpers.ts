...
export const getVariantClasses = (
    ...
    if (variant === 'primary') {
        const defaultClasses =
            'bg-white font-secondary text-gray-900 whitespace-nowrap';
        ...
        const focusSpacingClasses =
            'focus-visible:before:absolute focus-visible:before:inset-[-3px] focus-visible:before:-m-2'; // Use focus-visible instead of focus-within
        const inactiveClasses = 'bg-gray-100 text-gray-900 ring-gray-300';

        const uncheckedClasses =
            'hover:bg-primary-lightest hover:border-primary hover:z-10 relative border-2 border-gray-300'; // Added hover styles and border color for unchecked state
        ...
        const defaultClasses =
            'bg-transparent border-white text-white shadow-sm border';
        const hoverClasses =
            'hover:bg-gray-600 hover:text-white hover:border-white hover:border-1';
        const pressedClasses =
            'focus:bg-gray-800 focus:text-white focus:border-white';
        const selectedClasses =
            'active:bg-gray-700 active:text-white active:border-white active:border-4';
        const inactiveClasses =
            'bg-gray-800 text-gray-600 border-gray-600 border';
        ...
        const focusSpacingClasses =
            'focus-within:before:absolute focus-within:before:inset-0 focus-within:before:-m-2'; // Adjusted spacing for focus border
