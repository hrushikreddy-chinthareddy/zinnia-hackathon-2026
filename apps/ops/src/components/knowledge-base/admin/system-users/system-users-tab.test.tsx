...
describe('SystemUsersTab', () => {
    ...
    it('logs error when users cannot be fetched', async () => {
        (getAllUserDetails as jest.Mock).mockRejectedValue(
    ...
    it('sorts the users by updated and created date', async () => {
        ...
        const updatedDateCells = await findAllByTestId(
            'system-user-updated-date'
        );
        ...
        const createdDateCells = await findAllByTestId(
            'system-user-created-date'
        );
