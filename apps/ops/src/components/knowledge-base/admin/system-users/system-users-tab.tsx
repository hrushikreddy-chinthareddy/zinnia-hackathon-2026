            ...
            <React.Fragment key=".0">
              <TableHeader>
                <TableRow>
                  <TableHeaderCell
                    sortable={true}
                    onClick={() => toggleSort(SortFields.Name)}
                ...
                {sortedUsers.map((user) => {
                  return (
                    <TableRow key={user.email}>
                      <TableCell className="typography-content-body-sm" data-testid="system-user-name">
                        {user.name}
                      </TableCell>
                      ...
                      <TableCell className="typography-content-body-sm" data-testid="system-user-created-date">
                        {formatDateTime(
                          user?.createdAt || ''
                        )}
                      </TableCell>
                      <TableCell className="typography-content-body-sm" data-testid="system-user-updated-date">
                        {formatDateTime(
                          user?.updatedAt || ''
                        )}
                      </TableCell>
