...
const DocumentPreview = ({
  ...
  return (
    <div className="flex flex-1 gap-4 px-4 py-2 w-full h-full" data-testid="doc-preview">
      <div className="flex-1 bg-gray-50 p-4 rounded-md h-full ">
        ...
        {loading ? (
          <div className="w-full h-full flex items-center justify-center p-8" data-testid="doc-preview-loader">
            <Loader />
          </div>
        ) :
          document ? (
            <iframe src={document} width="100%" height="100%" data-testid='doc-preview-iframe' />
          ) :
