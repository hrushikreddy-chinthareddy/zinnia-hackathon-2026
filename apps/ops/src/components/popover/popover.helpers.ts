...
export const commonPopoverClasses =
    'z-40 max-w-[195px] max-h-[70vh] overflow-y-auto rounded bg-gray-900 p-3 text-left leading-4 tracking-[.00357em] text-white shadow-elevation-dark-08 sm:max-w-[320px] w-max';
