...
export const AiInsightSummary = ({
    ...
    const enableInsights =
        true || (shouldShowCaseInsights && !!content.length && !!prompt.length);
    const {
        data: insightData,
    ...
    const textContent = useMemo(() => {
        ...
        if (insightError) {
            ...
            textContent =
                'There were no cases available for analysis. Please provide the relevant data for further insights.';
