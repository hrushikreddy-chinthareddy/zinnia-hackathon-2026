...
// type LineAndVolumeCategoryAndSeries = {
//     weeklySeries: Record<string, summary>;
//     monthlySeries: Record<string, summary>;
...
// function processCarrierData(input: DashboardStatsElementResponse[]): LineAndVolumeCategoryAndSeries {
...
export const ExceptionSummary = ({
    ...
    useEffect(() => {
        ...
        Object.entries(processedData.monthlySeries).forEach(([, value]) => {
