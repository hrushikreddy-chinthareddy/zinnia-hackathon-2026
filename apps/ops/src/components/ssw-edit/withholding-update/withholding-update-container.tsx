...
type TaxWithholdingUpdateProps = {
    clientCode: string;
    policy: Policy;
    document: DocumentData;
};

const WithholdingUpdateContainer = ({ clientCode, policy, document }: TaxWithholdingUpdateProps) => {
...
export default WithholdingUpdateContainer;
