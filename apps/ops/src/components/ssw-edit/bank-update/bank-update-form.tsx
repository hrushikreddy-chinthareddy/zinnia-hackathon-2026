                ...
                <>
                    ...
                    <div className="flex justify-between">
                        <label className="font-primary text-lg font-bold">
                            {t('distributionMethod.bankUpdateTitle')}
                        </label>
                        <Button
                            className="mr-4"
                            onClick={() =>
                                handleFormAction(BankUpdateType.BankTerminate)
                            }
                    ...
                    <div className=" mx-6">
                        <div className="my-4 grid w-full grid-cols-3 gap-4">
                            <SelectSimple
                                ...
                                value={
                                    bankUpdateDetails.bankType ||
                                    ContributionType.Disbursement
                                }
                                name="sswType"
                            />
                        </div>
