...
export default function FundAllocations({
    ...
    const [fundAllocations, setFundAllocations] = useState(
        formDistribution?.funds || []
    );

    const setFundAllocation = (
        fundCode: string,
        ...
        <div className="mt-4">
            ...
            {fundAllocations.map((fundAlloc, index) => (
                <div
                    ...
                    key={fundAlloc.fundCode}
                >
                    <div
                        id={`fund-code-${fundAlloc.fundCode}`}
                    ...
                    <div className="flex gap-4 sm:gap-8">
                        <Field
                            ...
                            value={
                                fundAlloc.amount.amountType ===
                                AmountType.Dollar
                                    ? fundAlloc.amount.text
                                    : ''
                            }
