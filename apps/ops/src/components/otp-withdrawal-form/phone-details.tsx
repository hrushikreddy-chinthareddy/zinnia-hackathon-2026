...
const PhoneDetailsComponent = ({
    ...
    const [ownerPhoneDay, setOwnerPhoneDay] = useState(
        formData?.[0]?.phoneNumber || ''
    );
    const [ownerPhoneHome, setownerPhoneHome] = useState(
        formData?.[1]?.phoneNumber || ''
    );
        ...
        >
            ...
            <div className="mt-4 grid grid-rows-2 gap-8 sm:grid-cols-2 sm:grid-rows-1 md:grid-cols-3 ">
                ...
                <Field
                    ...
                    onChange={(e) =>
                        setownerPhoneHome(e.target.value as string)
                    }
                    size={FieldSize.Small}
                    type={FieldType.BaseActive}
