...
const PREVIOUS_ILLUSTRATED_RATE = 7.03;
const UPDATED_ILLUSTRATED_RATE = 6.94;

export function getFeatureFlagsDependentValues(
    featureFlags: FeatureFlags | undefined
): {
    illustratedRate: number;
} {
    const illustratedRate = featureFlags?.[
        FEATURE_FLAGS.SHOULD_USE_UPDATED_RATES_FOR_FIUL_SP
    ]
        ? UPDATED_ILLUSTRATED_RATE
        : PREVIOUS_ILLUSTRATED_RATE;
...
export const getFarmersBlueprintIU0101 = (
    featureFlags?: FeatureFlags
): QuestionnaireBlueprint => {
    const { illustratedRate } = getFeatureFlagsDependentValues(featureFlags);
                                        ...
                                        valid: [
                                            {
                                                ...
                                                message: {
                                                    en: `Future Interest Rate can not be higher than the current interest rate of ${illustratedRate}%.`,
                                                    fr: '',
                                                },
                                            },
                                        ],
...
// Backward compatibility: export the default blueprint for existing usages
export const farmersBlueprintIU0101 = getFarmersBlueprintIU0101();
