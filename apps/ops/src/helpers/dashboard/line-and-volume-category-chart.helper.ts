...
export function processGroupedData(
    ...
    // Create chart categories based on the determined earliest date and chart interval
    ...
    // Process each level1GroupedBy item in the input
    ...
    input.forEach((level1GroupedBy, i) => {
        ...
        // Initialize series for weekly and monthly data
        ...
        // Process each date and update the weekly and monthly data
