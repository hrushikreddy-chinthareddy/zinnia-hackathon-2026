...
export const EditAllocationsSystemDown = ({ sideSheet, setIsSystenDown, setIsNigo, setIsSuccessFlow }: {
    ...
    return (
        <div className="flex flex-col p-8 h-full items-center">
            ...
            <Typography variant={TypographyVariant.H3} className="text-center pb-1 pt-1">{t('fundAllocation.systemErrorTitle')}</Typography>
            <Typography variant={TypographyVariant.Body} className="text-center">{t('fundAllocation.systemErrorDes1')}
                <Typography variant={TypographyVariant.Body} className='!underline text-[#00628B]'>
            ...
            <div className="pt-10 min-w-[100px]">
                <Button
                    className="mx-auto"
                    onClick={() => { setIsSystenDown(false); setIsNigo(false); setIsSuccessFlow(false) }}
            ...
            <NavElement
                ...
                onClick={() => { setIsSystenDown(false); sideSheet.handleOpen(false) }}
