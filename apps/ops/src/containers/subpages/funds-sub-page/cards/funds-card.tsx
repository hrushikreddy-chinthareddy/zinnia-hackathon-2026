...
const FundsCard = ({ funds, loading, title, titleTooltip, policy, notElectedfunds }: FundsCardProps) => {
    ...
    useEffect(() => {
        const checkElligibility = async () => {
            const editAllocationEligibility = await checkEligibilityFundAllocation(policy.planCode, policy.policyNumber);
