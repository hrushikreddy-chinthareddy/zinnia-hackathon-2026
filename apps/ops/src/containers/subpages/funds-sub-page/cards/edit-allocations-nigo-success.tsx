...
export const EditAllocationsNigoSuccess = ({
    ...
    return (
        <div className="flex flex-col p-8 h-full items-center">
            ...
            <Typography variant={TypographyVariant.H3} className="pt-1 pb-1">
                {t('fundAllocation.submitted')}
            </Typography>
            <Typography variant={TypographyVariant.Body}>
                {t('fundAllocation.editAllocationNigoSummary1')}
                <Typography
                    variant={TypographyVariant.BodyBold}
                    className="inline"
                >
                    {t('fundAllocation.editAllocationNigoSummary2')}
                </Typography>
            </Typography>
