...
export default function getDeathClaimConfig(t: TFunction) {
  ...
  const otherRoleFields: FieldConfig[] = [
      { fieldName: ClaimFields.FirstName, fieldLabel: t('labels.otherNotifier.firstName') },
      { fieldName: ClaimFields.MiddleName, fieldLabel: t('labels.otherNotifier.middleName') },
      { fieldName: ClaimFields.LastName, fieldLabel: t('labels.otherNotifier.lastName') },
      { fieldName: ClaimFields.Suffix, fieldLabel: t('labels.otherNotifier.suffix') },
      { fieldName: ClaimFields.RelationShipToDeceased, fieldLabel: t('labels.otherNotifier.relationshipToDeceased'), fieldOption: relationshipToInsuredOptions, placeHolder: t('labels.otherNotifier.select') as string },
  ];
