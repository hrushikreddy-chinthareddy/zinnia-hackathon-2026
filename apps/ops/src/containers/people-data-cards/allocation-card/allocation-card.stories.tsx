...
export const AllocationCardContainer = () => {
    ...
    const relationshipToInsured = RelationshipToInsured.STEPFATHER;
    return (
        <div className="p-6">
            <AllocationCard
                allocation={allocation}
                deathBenefit={deathBenefit}
                relationshipToInsured={getRelationshipToInsured(relationshipToInsured, t) as RelationshipToInsured}
                selectedPartyId={''}
