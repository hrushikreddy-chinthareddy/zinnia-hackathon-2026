...
export const getFormErrors = ({ caseId, email, isDelete, t }: GetFormErrors) => {
    ...
    if (!emailAddress) {
        ...
        errors = { ...errors, emailAddress: t('people.sideSheet.email.errors.isInvalid') as string };
    }
...
export const getEmailTypes = ({ t }: GetEmailTypes) => [
    { label: t('people.card.email.emailOptions.personal') as string, value: EmailType.PERSONAL },
    { label: t('people.card.email.emailOptions.business') as string, value: EmailType.BUSINESS },
