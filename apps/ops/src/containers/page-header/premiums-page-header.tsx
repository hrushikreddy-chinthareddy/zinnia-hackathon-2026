        ...
        <>
            <div className="my-0 w-fit xs:mr-4 md:mr-0">
                <div className="flex items-center gap-2">
                    <span className="label relative font-primary text-sm font-bold leading-4.5">
                        {t(
                            'pageHeader.premiums.descriptionList.label.gracePeriodBeforeLapse'
                        )}
                    </span>
                    ...
                    <Popover
                        ...
                        body={
                            t(
                                'pageHeader.premiums.popOver.gracePeriodBeforeLapse'
                            ) as string
                        }
            ...
            <div className="my-0 w-fit xs:mr-4 md:mr-0">
                <div className="flex items-center gap-2">
                    <span className="label relative font-primary text-sm font-bold leading-4.5">
                        {t(
                            'pageHeader.premiums.descriptionList.label.gracePeriodMinPayment'
                        )}
                    </span>
                    ...
                    <Popover
                        ...
                        body={
                            t(
                                'pageHeader.premiums.popOver.gracePeriodMinPayment'
                            ) as string
                        }
                        placement={PopoverPlacement.TopRight}
                    >
                ...
                <div className="mb-0 ml-0 h-[25px] break-words font-primary text-[22px] font-medium leading-[26px]">
                    {numberFormatify(
                        values?.totalMinimumRequiredAmount ||
                            DEFAULT_ERROR_STRING
                    )}
                </div>
            </div>
    ...
    const belowHeaderTextChildren = (
        <div className="sm:flex-no-wrap mt-4 flex xs:w-[400px] xs:flex-wrap xs:gap-4 md:w-full md:gap-8">
            {policyStatus === PolicyStatus.PENDINGLAPSE && (
                <GracePeriodValues values={pendingLapse} />
            )}
            ...
            <div className="my-0 w-fit xs:mr-4 md:mr-0">
                <div className="flex items-center gap-2">
                    <span className="label relative font-primary text-sm font-bold leading-4.5">
                        {t(
                            'pageHeader.premiums.descriptionList.label.ytdPremium'
                        )}
                    </span>
                </div>
                ...
                <div className="mb-0 ml-0 h-[25px] break-words font-primary text-[22px] font-medium leading-[26px]">
                    {!isNullEmptyOrUndefined(
                        policyValues?.totalYearToDatePremiumAmount
                    )
                        ? numberFormatify(
                              policyValues?.totalYearToDatePremiumAmount,
                              currencyFormat
                ...
                {isTerm && (
                    <div className="ml-0 break-words font-primary text-sm leading-[20px] text-[#676767]">
                        {`${t(
                            'pageHeader.premiums.descriptionList.label.unearnedPremium'
                        )}: ${numberFormatify(
                            unearnedPremium,
                            currencyFormat
                        )}`}
            ...
            <div className="my-0 w-fit xs:mr-4 xs:w-[187px] md:mr-0 md:w-auto">
                <div className="flex items-center gap-2">
                    <span
                        className={` label relative font-primary text-sm font-bold leading-4.5`}
                    >
                        {t(
                            'pageHeader.premiums.descriptionList.label.allTimePremium'
                        )}
                    </span>
                </div>
                ...
                <div className="mb-0 ml-0 h-[25px] font-primary text-[22px] font-medium leading-[26px]">
                    {!isNullEmptyOrUndefined(
                        policyValues?.cumulativePremiumSinceIssue
                    )
                        ? numberFormatify(
                              policyValues?.cumulativePremiumSinceIssue as number,
                              currencyFormat
                          )
                        : '-'}
                </div>
            ...
            {!isTerm && (
                <div className="my-0 w-fit xs:mr-4 md:mr-0">
                    <div className="flex items-center gap-2">
                        <span className="label relative font-primary text-sm font-bold leading-4.5">
                            {t(
                                'pageHeader.premiums.descriptionList.label.costBasis'
                            )}
                        </span>
                        ...
                        <Popover
                            ...
                            body={
                                t(
                                    'pageHeader.premiums.popOver.costBasis'
                                ) as string
                            }
                            placement={PopoverPlacement.TopRight}
                        >
                ...
                <>
                    <div className="my-0 w-fit xs:mr-4 md:mr-0">
                        <div className="flex items-center gap-2">
                            <span className="label relative font-primary text-sm font-bold leading-4.5">
                                {t(
                                    'pageHeader.premiums.descriptionList.label.annualizedPremium'
                                )}
                            </span>
                            ...
                            <Popover
                                ...
                                body={
                                    t(
                                        'pageHeader.premiums.popOver.annualizedPremium'
                                    ) as string
                                }
                                placement={PopoverPlacement.TopRight}
                            >
                        ...
                        <div className="mb-0 ml-0 h-[25px] break-words font-primary text-[22px] font-medium leading-[26px]">
                            {numberFormatify(annualizedPremium, currencyFormat)}
                        </div>
                    </div>
                </>
            )}
