...
const MECCard = ({
    ...
    const tooltipText = isMEC
        ...
        : t('premium.mecCard.statusToolTipMecNo') +
          t('premium.mecCard.statusToolTipDate', {
              mecTestDate: formattedTestDate,
          });
        ...
        <article className={articleClasses}>
            ...
            <div className={guidelinesContainerClasses}>
                <PolicyTestCard
                    amountProps={{
                        label: t(
                            'premium.mecCard.guidelineTests.amountRemaining.label'
                        ),
                        tooltipBody: t(
                            'premium.mecCard.guidelineTests.amountRemaining.tooltipBody'
                        ),
                        tooltipTitle: t(
                            'premium.mecCard.guidelineTests.amountRemaining.label'
                        ),
                    ...
                    basisProps={{
                        ...
                        tooltipBody: t(
                            'premium.mecCard.guidelineTests.basis.tooltipBody'
                        ),
                        tooltipTitle: t(
                            'premium.mecCard.guidelineTests.basis.label'
                        ),
                    }}
                    ...
                    totalProps={{
                        ...
                        tooltipBody: t(
                            'premium.mecCard.guidelineTests.total.tooltipBody'
                        ),
                        tooltipTitle: t(
                            'premium.mecCard.guidelineTests.total.label'
                        ),
                    }}
                />
            </div>
                    ...
                    <div className="flex">
                        ...
                        >
                            <Badge
                                ...
                                label={
                                    isMEC
                                        ? t('premium.mecCard.isMEC')
                                        : t('premium.mecCard.isNotMEC')
                                }
