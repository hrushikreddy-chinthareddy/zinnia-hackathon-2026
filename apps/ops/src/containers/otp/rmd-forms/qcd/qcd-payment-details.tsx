...
const QcdPaymentDetails: React.FC<QcdPaymentDetailsProps> = ({ qcdDetails, isFormStateReadOnly, id, onDeleteQcd, onDataChange }) => {
        ...
        <div className="flex">
            <div>
                <Field
                    ...
                    onChange={e => onDataChange('charityName', e.target.value, id)}
                ...
                <Field
                    ...
                    onChange={e => onDataChange('amount', { text: e.target.value, amountType: 'DOLLAR' }, id)}
                    size={FieldSize.Small}
                    type={FieldType.BaseActive}
