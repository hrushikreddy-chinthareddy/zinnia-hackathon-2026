...
const oftDlicConfig = getOftDlicConfig(t);

describe('Config existence', () => {
    it('should return an object with the correct configuration options', () => {
        expect(oftDlicConfig.formValidation).toBeDefined();
        expect(oftDlicConfig.signaturesConfig).toBeDefined();
        expect(oftDlicConfig.formPartyConfigs).toBeDefined();
        expect(oftDlicConfig.surrenderingInstructionsOptions).toBeDefined();
        expect(oftDlicConfig.disbursementOptions).toBeDefined();
    });
});
...
describe('formValidation', () => {
    ...
    const { formValidation } = oftDlicConfig;
    ...
    it('should correctly render the formData payload', async () => {
        ...
        expect(setMockData).toHaveBeenCalledWith({
            formExtName: `DLIC_OFT_DIGITAL_FORM`,
            metaData: {
                formId: null,
                formNumber: '',
                formType: `DLIC_OFT_DIGITAL_FORM`,
            },
        });
    });

    describe('signaturesConfig', () => {
        const { signaturesConfig } = oftDlicConfig;
