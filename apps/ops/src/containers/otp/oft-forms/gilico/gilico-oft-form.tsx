...
import getFlicOftConfig from './gilico-oft-form.helper';

export default function GilicoOftWithdrawalForm() {
  ...
  useEffect(() => {
    setFormData({
      ...formData,
      formExtName: `${initialForm?.carrier || Carrier.GLCO}_OFT_DIGITAL_FORM`,
      metaData: {
        formType: `${initialForm?.carrier || Carrier.GLCO}_OFT_DIGITAL_FORM`,
        formId: null,
        formNumber: '',
      },
    });
