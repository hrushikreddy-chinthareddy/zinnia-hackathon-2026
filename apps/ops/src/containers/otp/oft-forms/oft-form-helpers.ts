...
import { FormParts, FormValidationErrors, PaymentMethod, QualTypes } from "@deps/models/case/withdrawal/case";

export const getQualTypeOptions = (t: TFunction) => ([
    { label: t('oftProcess.qualTypes.nonQualified'), value: QualTypes.NonQualified },
    { label: t('oftProcess.qualTypes.convertedRothIRA'), value: QualTypes.ConvertedRothIRA },
    { label: t('oftProcess.qualTypes.custInhIRA'), value: QualTypes.CustInhIRA },
    { label: t('oftProcess.qualTypes.custInhRothIRA'), value: QualTypes.CustInhRothIRA },
    { label: t('oftProcess.qualTypes.custRolloverIRA'), value: QualTypes.CustRolloverIRA },
    { label: t('oftProcess.qualTypes.custSARSEPIRA'), value: QualTypes.CustSARSEPIRA },
    { label: t('oftProcess.qualTypes.custSimpleIRA'), value: QualTypes.CustSimpleIRA },
    { label: t('oftProcess.qualTypes.custSpousalIRA'), value: QualTypes.CustSpousalIRA },
    { label: t('oftProcess.qualTypes.custodialIRA'), value: QualTypes.CustodialIRA },
    { label: t('oftProcess.qualTypes.custodialIRASEP'), value: QualTypes.CustodialIRASEP },
    { label: t('oftProcess.qualTypes.custodialQLACIRA'), value: QualTypes.CustodialQLACIRA },
    { label: t('oftProcess.qualTypes.custodialRothIRA'), value: QualTypes.CustodialRothIRA },
    { label: t('oftProcess.qualTypes.inheritedIRA'), value: QualTypes.InheritedIRA },
    { label: t('oftProcess.qualTypes.inheritedRothIRA'), value: QualTypes.InheritedRothIRA },
    { label: t('oftProcess.qualTypes.iRARegular'), value: QualTypes.IRARegular },
    { label: t('oftProcess.qualTypes.iRARollover'), value: QualTypes.IRARollover },
    ...
    { label: t('oftProcess.qualTypes.iRASpousal'), value: QualTypes.IRASpousal },
    ...
    { label: t('oftProcess.qualTypes.aSchedA401'), value: QualTypes.aSchedA401 },
    ...
    { label: t('oftProcess.qualTypes.deferredComp457'), value: QualTypes.DeferredComp457 },
    { label: t('oftProcess.qualTypes.corporatePension'), value: QualTypes.CorporatePension },
    ...
    { label: t('oftProcess.qualTypes.moneyPurchasePensionPlan'), value: QualTypes.MoneyPurchasePensionPlan },
    { label: t('oftProcess.qualTypes.pensionPlan'), value: QualTypes.PensionPlan },
