...
import GilicoWithdrawalForm from './gilico-withdrawal-form';
...
describe('GILICO Form Specific component', () => {
    ...
    const gilicoConfig = getGilicoConfig(
        t,
        FormSubtype.FullWithdrawal,
        FASTQualTypes.CUSTODIALINDIVIDUALRETIREMENTACCOUNT
    );

    describe('Config existence', () => {
        it('should return an object with the correct configuration options', () => {
            expect(gilicoConfig.formValidation).toBeDefined();
            expect(gilicoConfig.signaturesConfig).toBeDefined();
            expect(gilicoConfig.formPartyConfigs).toBeDefined();
            expect(gilicoConfig.disbursementOptions).toBeDefined();
        });
    });

    it('should render the gilico form', () => {
    ...
    it('should correctly render the formData payload', async () => {
        ...
        expect(setMockData).toHaveBeenCalledWith({
            formExtName: `GILICO_WD_REDEMPTION_undefined_DIGITAL_FORM`,
            metaData: {
                formId: null,
                formNumber: '',
                formType: `GILICO_WD_REDEMPTION_undefined_DIGITAL_FORM`,
            },
        });
    });

    describe('formValidation', () => {
        const { formValidation } = gilicoConfig;
    ...
    describe('signaturesConfig', () => {
        const { signaturesConfig } = gilicoConfig;
