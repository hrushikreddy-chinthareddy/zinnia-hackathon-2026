    ...
    describe('identifySelectedFormProgramOption', () => {
        it('should correctly identify the selected form program option', () => {
            ...
            const selectedOption =
                flicConfig.identifySelectedFormProgramOption(formProgram);
        ...
        describe('payload generation', () => {
            ...
            it('should correctly generate a payload for the Total Free Withdrawal selection', () => {
                const totalFree = partialWithdrawalOptions.find(
                    (option) =>
                        option.value ===
                        WithdrawalSelectionValues.TotalFreeWithdrawal
                );
            ...
            it('should correctly generate a payload for the Net Withdrawal selection', () => {
                const netWithdrawal = partialWithdrawalOptions.find(
                    (option) =>
                        option.value === WithdrawalSelectionValues.NetWithdrawal
                );
