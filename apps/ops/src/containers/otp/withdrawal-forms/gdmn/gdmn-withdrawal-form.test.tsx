...
describe('GDMN Form Specific component', () => {
    ...
    it('should render the partial formtype default', () => {
        ...
        expect(setMockData).toHaveBeenCalledWith({
            formExtName: `GDMN_WD_REDEMPTION_${FormSubtype.PartialWithdrawal.toUpperCase()}_DIGITAL_FORM`,
            metaData: {
                formId: null,
                formNumber: '',
                formType: `GDMN_WD_REDEMPTION_${FormSubtype.PartialWithdrawal.toUpperCase()}_DIGITAL_FORM`,
            },
        });
    });
    ...
    it('should correctly render the formData payload on formType Full', async () => {
        ...
        expect(setMockData).toHaveBeenCalledWith({
            formExtName: `GDMN_WD_REDEMPTION_${FormSubtype.FullWithdrawal?.toUpperCase()}_DIGITAL_FORM`,
            metaData: {
                formId: null,
                formNumber: '',
                formType: `GDMN_WD_REDEMPTION_${FormSubtype.FullWithdrawal?.toUpperCase()}_DIGITAL_FORM`,
            },
        });
    });
