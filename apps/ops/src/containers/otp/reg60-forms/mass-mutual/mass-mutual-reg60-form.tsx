...
export default function MassMutualReg60Form({
    document,
    planCode,
}: {
        ...
        if (document) {
            setOwnerInformation({
                ...
                personalInformation: {
                    ...
                    firstName:
                        ownerInformation.personalInformation.firstName ||
                        document?.firstName,
                    lastName:
                        ownerInformation.personalInformation.lastName ||
                        document?.lastName,
                    ssNumber:
                        ownerInformation.personalInformation.ssNumber ||
                        document.ssNTaxId ||
                        '',
                },
            });
            ...
            setAgentInformation({
                ...
                channel:
                    agentInformation.channel || document?.distributionChannel,
                personalInformation: {
                    ...agentInformation.personalInformation,
                    firstName:
                        agentInformation.personalInformation.firstName ||
                        document?.agentFirstName,
                    lastName:
                        agentInformation.personalInformation.lastName ||
