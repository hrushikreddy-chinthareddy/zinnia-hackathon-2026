...
import UlpcRenewalForm from './ulpc-form';
...
describe('UlpcRenewalForm', () => {
    ...
    describe('Context Values Access', () => {
        ...
        it('should properly access and use planCode context value for multi-selection (plan 775)', () => {
            render(
                <RenewalFormDataContext.Provider
                    value={{ ...defaultContextValue, planCode: '775' }}
                >
                    <UlpcRenewalForm />
                </RenewalFormDataContext.Provider>
            );

            // RenewalPeriodMultiSection should be rendered for plan code 775
            expect(
