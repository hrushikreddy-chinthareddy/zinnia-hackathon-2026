...
export const getPolicyQuickLinks = async (
    ...
    const { showFundsAndAccounts, showLoans, showWithdrawals, detailLinkType } =
        await getPolicyVisibility(policy);

    return [
        {
            href: t('site.navLinks.policyDetails.link', {
                id: policyNumber,
                planCode,
            }),
            name: t(
                policy.isLife
                    ? 'site.navLinks.policyDetails.altText'
                    : 'site.navLinks.contractDetails.altText'
            ),
            hideLabel: true,
            subLinks: [
                {
                    ...
                    href:
                        t(`site.navLinks.${detailLinkType}.link`, {
                            id: policyNumber,
                            planCode,
                        }) || '',
                },
                    ...
                    : []),
                {
                    ...
                    href:
                        t(`site.navLinks.ridersAndFeatures.link`, {
                            id: policyNumber,
                            planCode,
                        }) || '',
                },
...

                {
                    ...
                    href:
                        t('site.navLinks.transactions.premiums.href', {
                            id: policyNumber,
                            planCode,
                        }) || '',
                },
                    ...
                    ? [
                          {
                              ...
                              href:
                                  t('site.navLinks.transactions.loans.href', {
                                      id: policyNumber,
                                      planCode,
                                  }) || '',
                          },
                ...
                ...(showWithdrawals
                    ? [
                          {
                              name: t(
                                  'site.navLinks.transactions.withdrawals.text'
                              ),
                              href:
                                  t(
                                      'site.navLinks.transactions.withdrawals.href',
                    ...
                    ? [
                          {
                              ...
                              href:
                                  t('site.navLinks.annuitization.href', {
                                      id: policyNumber,
                                      planCode,
                                  }) || '',
                          },
        ...
        {
            href: t('site.navLinks.people.link', {
                id: policyNumber,
                planCode,
            }),
        ...
        {
            href: t('site.navLinks.history.link', {
                id: policyNumber,
                planCode,
            }),
            ...
            subLinks: [
                {
                    name: t(
                        `site.navLinks.activity.subLinks.transactions.text`
                    ),
                    href: t(
                        `site.navLinks.activity.subLinks.transactions.link`,
                        { id: policyNumber, planCode }
                    ),
                },
                ...(hasCallLogsAccess
        ...
        {
            href: t('site.navLinks.documents.link', {
                id: policyNumber,
                planCode,
            }),
