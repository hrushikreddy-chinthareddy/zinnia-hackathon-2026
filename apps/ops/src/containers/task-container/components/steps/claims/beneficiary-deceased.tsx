...
function BeneficiaryDeceased({ beneficiary, setBeneficiary, t }: BeneficiaryDeceasedProps) {
  return (
    <>
      <div className="col-span-1 mt-4">
        <FieldDate
          ...
          onDateSelect={(val: Date | undefined) => {
            ...
            setBeneficiary({ ...beneficiary, beneDeathDate: val?.toLocaleDateString() || null });
          }}
        />
      ...
      <div className="col-span-1 mt-4">
        ...
        <input
          ...
          onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
            setBeneficiary({ ...beneficiary, beneDeathSourceOfInfo: e.target.value })
          }}
        />
      </div>
    </>
