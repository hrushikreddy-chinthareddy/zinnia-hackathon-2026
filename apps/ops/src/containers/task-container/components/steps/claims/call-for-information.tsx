...
function CallForInformation({ task, setTask, onContinueReady, correlationId, setSubmitFailed, setFormErrors, beneficiary, setBeneficiary, t }: {
  task: any;
                    ...
                    if (typeof newValue === 'string') {
                      ...
                      setBeneficiary(prev => ({
                        ...
                        notificationPreferences: {
                          ...
                          notificationMethod: {
                            method: task?.data?.details?.[dynamicKey]?.beneficiary?.notificationPreferences?.notificationMethod?.method,
