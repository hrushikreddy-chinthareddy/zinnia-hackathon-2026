...
export const buildLoanPaymentRequestBody = (loanPayment: LoanPayment): LoanRepaymentOneTimeRequestQuery => {
    return {
        caseId: loanPayment.caseId || '',
        correlationId: uuidV4(),
        effectiveDate: dayjs(loanPayment.effectiveDate, 'MMDDYYYY').format(ZAHARA_API_DATE_FORMAT),
        payor: {
