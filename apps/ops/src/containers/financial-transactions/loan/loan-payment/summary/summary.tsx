...
const Summary = ({ policy }: SummaryProps) => {
    const { t } = useTranslation(TranslationFiles.COMMON, { keyPrefix: 'loanPayment.summary' });
    ...
    const { paymentAmount, effectiveDate, paymentAccountNumber, paymentBranchName, payorFullName, validationResponse } = loanPayment;
        ...
        <div>
            ...
            <CardContainer>
                ...
                <TransactionNavigationButtons
                    ...
                    trackEventProps={{ type: TransactionType.PAYMENT_LOAN_REPAYMENT_ONE_TIME, step: TransactionStep.Summary }}
                />
            </CardContainer>
        </div>
    );
