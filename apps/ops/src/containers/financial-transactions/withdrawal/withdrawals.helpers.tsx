import { AllocationOption, AmountType, FullSurrenderRequest, PartialWithdrawalOneTimeRequest, PaymentForm } from "@zinnia/api-types/types/bpm";
...
export const buildWithdrawalsRequestBody = (withdrawal: Withdrawal, wireCheckPaymentsEnabled: boolean): FullSurrenderRequest | PartialWithdrawalOneTimeRequest => {
