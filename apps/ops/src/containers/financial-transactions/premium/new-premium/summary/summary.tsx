...
const Summary = ({ policy }: SummaryProps) => {
    const { t } = useTranslation(TranslationFiles.COMMON, { keyPrefix: 'newPremium.summary' });
            ...
            <CardContainer classNames="flex w-full flex-col items-start text-gray-900">
                ...
                <div className="flex w-full flex-row gap-8">
                    <div className="flex flex-col">
                        <Label variant={LabelVariant.FieldLabel} label={t('paymentLabel')} />
                        <Typography variant={TypographyVariant.Value}>{numberFormatify(paymentAmount)}</Typography>
                    </div>

                    <div className="flex flex-col">
                        <Label variant={LabelVariant.FieldLabel} label={t('effectiveDateLabel')} />
