...
export default function ContactInfo() {
    const { t } = useTranslation(TranslationFiles.COMMON, {
        keyPrefix: 'beneChange.beneDetails.contactInfo',
    });

    const items: RadioItem[] = [
        {
            label: t('labels.options.phone'),
            value: PreferredCommunicationType.PHONE,
        },
        {
            label: t('labels.options.email'),
            value: PreferredCommunicationType.EMAIL,
        },
        {
            label: t('labels.options.fax'),
            value: PreferredCommunicationType.FAX,
        },
    ];
