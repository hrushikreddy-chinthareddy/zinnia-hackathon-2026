...
export type EnterprisePhoneType = typeof ENTERPRISE_PHONE_TYPE[keyof typeof ENTERPRISE_PHONE_TYPE];
...
export const getPhoneTypeOptions = ({ t }: GetPhoneTypeOptions) => [
    { label: t('labels.phoneOptions.businessFax'), value: ENTERPRISE_PHONE_TYPE.FAX },
    { label: t('labels.phoneOptions.businessPhone'), value: ENTERPRISE_PHONE_TYPE.BUSINESS },
    { label: t('labels.phoneOptions.mobilePhone'), value: ENTERPRISE_PHONE_TYPE.MOBILE },
    { label: t('labels.phoneOptions.homeFax'), value: ENTERPRISE_PHONE_TYPE.HOMEFAX },
    { label: t('labels.phoneOptions.modem'), value: ENTERPRISE_PHONE_TYPE.MODEM },
    { label: t('labels.phoneOptions.homePhone'), value: ENTERPRISE_PHONE_TYPE.HOME },
    { label: t('labels.phoneOptions.secondaryHomePhone'), value: ENTERPRISE_PHONE_TYPE.SECONDARYHOME },
    { label: t('labels.phoneOptions.other'), value: ENTERPRISE_PHONE_TYPE.OTHER },
];
...
export const getTimeZoneOptions = ({ t }: GetTimeZoneOptions) => [
    ...
    {
        label: t(`labels.timeZoneOptions.${TimeZoneAbbreviations.akt}`, { abbreviation: TimeZoneAbbreviations.akt }),
        value: TimeZoneAbbreviations.akt,
    },
    {
        label: t(`labels.timeZoneOptions.${TimeZoneAbbreviations.ct}`, { abbreviation: TimeZoneAbbreviations.ct }),
        value: TimeZoneAbbreviations.ct,
    },
    {
        label: t(`labels.timeZoneOptions.${TimeZoneAbbreviations.et}`, { abbreviation: TimeZoneAbbreviations.et }),
        value: TimeZoneAbbreviations.et,
    },
    {
        label: t(`labels.timeZoneOptions.${TimeZoneAbbreviations.ht}`, { abbreviation: TimeZoneAbbreviations.ht }),
        value: TimeZoneAbbreviations.ht,
    },
    {
        label: t(`labels.timeZoneOptions.${TimeZoneAbbreviations.mt}`, { abbreviation: TimeZoneAbbreviations.mt }),
        value: TimeZoneAbbreviations.mt,
    },
    {
        label: t(`labels.timeZoneOptions.${TimeZoneAbbreviations.pt}`, { abbreviation: TimeZoneAbbreviations.pt }),
...
export const getHomePhone = ({ phones }: EnterprisePhones): EnterprisePhone[] => {
    if (!phones) return [];
...
export function formatPhoneNumberWithCountryCode(phone: EnterprisePhone): string {
    let formattedNumber = '';
