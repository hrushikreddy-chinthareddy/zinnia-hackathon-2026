...
export default withAuthAndLogging(
  async (req: NextApiRequest, res: NextApiResponse, loggingContext) => {
    ...
    try {
      ...
      while (true) {
        ...
        for (const part of parts) {
          ...
          try {
            ...
            logTrace('Parsed upstream event', { type: event.type, ...loggingContext });
            ...
            if (event.type === SSEEventType.STATUS) {
              ...
              logError('Received ERROR event', { error: event.error, ...loggingContext });
      ...
      res.status(HttpStatusCode.InternalServerError).json({ error: 'Failed to connect to chat stream' });
    }
  },
  {
