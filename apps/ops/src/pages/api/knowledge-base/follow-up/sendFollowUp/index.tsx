...
export default withAuthAndLogging(
  async (
    ...
    const { messageId, followUpQuestion, clientId, parentFollowUpId = null } = req.body;
    ...
    if (!messageId || !followUpQuestion || !clientId) {
      ...
      return res.status(400).json({ error: 'missing messageId, followUpQuestion or clientId' });
    }
