...
export default withAuthAndLogging(
    async (
        req: NextApiRequest,
        res: NextApiResponse<DocumentDownloadV2 | any | null>,
        loggingContext
    ) => {
        ...
        if (!canUnmask) {
            logCompliance(
                'Document Preview request denied due to missing unmask pii permission',
                loggingContext
            );
    ...
    {
        file: 'document/v3/documents/:documentId/preview',
