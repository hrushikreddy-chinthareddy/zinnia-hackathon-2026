...
export default withAuthAndLogging(
    async (req, res, loggingContext) => {
        const { sellingCode, partialFullName } = req.query;

        try {
            const producersUrl = `${apiServerBaseUrl}/distributors/v1/hierarchies/selling-code/${sellingCode}/downline?partialFullName=${partialFullName}`;
            ...
            logWarn(
                'distributors/v1/hierarchies/selling-code/:selling-code/downline',
                {
