...
export enum TaskType {
    ...
    External_Review_Task = 'TASK_EXTERNAL_REVIEW_TASK',
    External_Data_Request_Task = 'EXTERNAL_DATA_REQUEST_TASK',
    External_Approval_Task = 'NB_EXTERNAL_APPROVAL_TASK',
    ...
    Ownerchange_Data_Entry = 'OWNERCHANGE_DATA_ENTRY',
    ...
    payeechange_data_entry = 'PAYEECHANGE_DATA_ENTRY',
    Initiate_AnnuitantChange_Transaction = 'INITIATE_ANNUITANTCHANGE_TRANSACTION',
