...
export const CaseApiVersionMapper: Record<CaseType, ApiVersion> = {
    ...
    [CaseType.Renewal]: ApiVersion.v2,
...
export const TaskApiVersionMapper: Record<TaskType, ApiVersion> = {
    ...
    [TaskType.RENEWAL]: ApiVersion.v2,
    [TaskType.RENEWAL_TASK]: ApiVersion.v2,
    ...
    [TaskType.Duplicate_Review]: ApiVersion.v2,
    [TaskType.Payment_Follow_Up]: ApiVersion.v2,
    [TaskType.Suitaibility_DataEntry_Nigo_Review]: ApiVersion.v2,
    [TaskType.Claims_Identify_Uncashed_Transactions]: ApiVersion.v2,
    [TaskType.Claims_Stop_Uncashed_Transactions]: ApiVersion.v2,
    ...
    [TaskType.Day_150_Review]: ApiVersion.v2,
    [TaskType.Bene_Call]: ApiVersion.v2,
    ...
    [TaskType.Quality_Audit_Review]: ApiVersion.v2,
    [TaskType.Quality_Audit_Rework]: ApiVersion.v2,
    [TaskType.Quality_Rework_Audit_Review]: ApiVersion.v2,
    [TaskType.Update_Suitability_DataEntry]: ApiVersion.v2,
    [TaskType.Initiate_BeneChange_Transaction]: ApiVersion.v2,
};
