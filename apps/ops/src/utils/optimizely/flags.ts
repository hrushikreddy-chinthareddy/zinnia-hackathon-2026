...
export enum FEATURE_FLAGS {
    ...
    WITHDRAWAL_USAA = 'case-management-otp_feature_usaa_withdrawal',
    ...
    NIGO_ENTRY_USAA_WITHDRAWAL = 'nigo-entry_usaa_withdrawal',
    ...
    MARKET_CONNECT_ILLUSTRATION = 'market_connect_illustration',
    ...
    CREATE_CARRIER_EXTERNAL_TASK = 'create-carrier-external-task',
}
