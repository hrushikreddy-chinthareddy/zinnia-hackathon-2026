...
export enum FEATURE_FLAGS {
    ...
    // DEPU-3596 Send tax forms
    SEND_TAX_FORMS_MAIL_SBGC = 'contact-center-send-taxforms-mail-sbgc',
    SEND_TAX_FORMS_MAIL_GDMN = 'contact-center-send-taxforms-mail-gdmn',
    SEND_TAX_FORMS_FAX_GDMN = 'contact-center-send-taxforms-fax-gdmn',
    SEND_TAX_FORMS_MAIL_MASS = 'contact-center-send-taxforms-mail-mass',
    SEND_TAX_FORMS_FAX_MASS = 'contact-center-send-taxforms-fax-mass',
    SEND_TAX_FORMS_EMAIL_MASS = 'contact-center-send-taxforms-email-mass',
    SEND_TAX_FORMS_MAIL_DLIC = 'contact-center-send-taxforms-mail-dlic',
    SEND_TAX_FORMS_FAX_DLIC = 'contact-center-send-taxforms-fax-dlic',
    SEND_TAX_FORMS_EMAIL_DLIC = 'contact-center-send-taxforms-email-dlic',
    SEND_TAX_FORMS_MAIL_NASU = 'contact-center-send-taxforms-mail-nasu',
    SEND_TAX_FORMS_FAX_NASU = 'contact-center-send-taxforms-fax-nasu',
    SEND_TAX_FORMS_EMAIL_NASU = 'contact-center-send-taxforms-email-nasu',
    SEND_TAX_FORMS_MAIL_ULPC = 'contact-center-send-taxforms-mail-ulpc',
    SEND_TAX_FORMS_FAX_ULPC = 'contact-center-send-taxforms-fax-ulpc',
    SEND_TAX_FORMS_MAIL_RSLN = 'contact-center-send-taxforms-mail-rsln',
    SEND_TAX_FORMS_FAX_RSLN = 'contact-center-send-taxforms-fax-rsln',
    SEND_TAX_FORMS_MAIL_GLCO = 'contact-center-send-taxforms-mail-glco',
    SEND_TAX_FORMS_FAX_GLCO = 'contact-center-send-taxforms-fax-glco',
    SEND_TAX_FORMS_MAIL_USAA = 'contact-center-send-taxforms-mail-usaa',
    SEND_TAX_FORMS_FAX_USAA = 'contact-center-send-taxforms-fax-usaa',
    SEND_TAX_FORMS_MAIL_FLIC = 'contact-center-send-taxforms-mail-flic',
    SEND_TAX_FORMS_FAX_FLIC = 'contact-center-send-taxforms-fax-flic',
    SEND_TAX_FORMS_MAIL_PRDN = 'contact-center-send-taxforms-mail-prdn',
    SEND_TAX_FORMS_FAX_PRDN = 'contact-center-send-taxforms-fax-prdn',
    SEND_TAX_FORMS_MAIL_PRUD = 'contact-center-send-taxforms-mail-prud',
    SEND_TAX_FORMS_FAX_PRUD = 'contact-center-send-taxforms-fax-prud',
    SEND_TAX_FORMS_MAIL_ILNA = 'contact-center-send-taxforms-mail-arcus',
    SEND_TAX_FORMS_MAIL_SAAG = 'contact-center-send-taxforms-mail-saag',
    SEND_TAX_FORMS_MAIL_GLAC = 'contact-center-send-taxforms-mail-glac',
    SEND_TAX_FORMS_FAX_GLAC = 'contact-center-send-taxforms-fax-glac',
    SEND_TAX_FORMS_MAIL_EMRS = 'contact-center-send-taxforms-mail-emrs',
    SEND_TAX_FORMS_FAX_EMRS = 'contact-center-send-taxforms-fax-emrs',
    SEND_TAX_FORMS_MAIL_JHLI = 'contact-center-send-taxforms-mail-jhli',
    SEND_TAX_FORMS_FAX_JHLI = 'contact-center-send-taxforms-fax-jhli',
}
