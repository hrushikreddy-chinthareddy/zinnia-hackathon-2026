...
export const mockPolicyData = () => {
    ...
    const policySummary: LabelValue[] = [
        ...
        {
            label: 'Face amount',
            value: numberFormatify('1000.00'),
            col: 2,
            tooltip: 'Face amount',
        },
        {
            label: 'Account value',
            value: numberFormatify('1080.00'),
            col: 2,
            tooltip: 'Account value',
        },
        {
            label: 'Net Surrender value',
            value: numberFormatify('7009.00'),
            col: 2,
            tooltip: 'Net Surrender value',
        },
    ];
            ...
            <div>
                {array
                    ...
                    .map(({ label, value, tooltip }: LabelValue) => (
                        <DescriptionList
                            key={'mock-data-description-list-policy-' + label}
                            label={label}
                            text={value}
                            tooltip={tooltip}
                        />
    ...
    return [
        <PolicyOwnerInfo key="owner" />,
        <PolicySummaryInfo key="summary" />,
    ];
};
