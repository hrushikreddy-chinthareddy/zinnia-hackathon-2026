...
export const getStatusIcon = (
    ...
    switch (status) {
        case Statuses.Exception:
            return (
                <Image
                    src={AlertExclamationIcon}
                    alt={t('status.exception')}
...
export const useStatusInfo = (
    ...
    const { accentColor, statusIcon, reasonText, detailedReasonText } =
        getStatusData(t, status, reason, detailedReason);
    const updatedText = toSentenceCase(
        t('temporal.lastUpdated') + ' ' + useTimestampText(t, updatedAt)
    );
