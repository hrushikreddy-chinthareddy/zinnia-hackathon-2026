...
export function useIntersectionObserver({
    ...
    const JSONThreshold = JSON.stringify(threshold);
    ...
    useEffect(() => {
        ...
        const observer = new IntersectionObserver(
            ...
            { threshold: JSON.parse(JSONThreshold), root, rootMargin }
        );
    ...
    }, [ref, JSONThreshold, root, rootMargin, frozen, freezeOnceVisible]);
