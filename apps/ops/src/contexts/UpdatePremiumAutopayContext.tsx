...
import { ReverseInitiatorType } from '@deps/containers/new-premium-container/amount/amount';
import { AmountType } from '@deps/containers/update-premium-autopay-container/amount/amount';
...
export const useUpdatePremiumAutopay = () => {
    ...
    if (!context) {
        throw new Error('useUpdateAutopay must be used within a UpdateAutopayProvider');
    }
    return context;
};
