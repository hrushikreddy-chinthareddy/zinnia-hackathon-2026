...
export const calculateRmd = async (query: CalculateRmdBody): Promise<CalculateRmdResponse> => {
    try {
        const response = await client.post<CalculateRmdBody, AxiosResponse>(`${baseUrl}/rmd`, query);
