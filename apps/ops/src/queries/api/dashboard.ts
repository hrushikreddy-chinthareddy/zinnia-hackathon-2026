...
export const fetchDashboardStats = async (
    ...
    try {
        ...
        browserLogError('fetchDashboardStats', {
...
export const fetchDashboardStatsSSR = async (
    accessToken: string,
...
export const fetchCompletedCasesByProcessSubTypeSSR = async (
    accessToken: string,
    loggingContext: LoggingContext,
    config?: AxiosAuthRequestConfig
): Promise<DashboardResponseData[]> =>
...
export const fetchTop5ProductsSSR = async (
    accessToken: string,
    loggingContext: LoggingContext,
    config?: AxiosAuthRequestConfig
): Promise<DashboardResponseData[]> =>
