@DEPU-1131
Feature: Ops user views extra details for a policy    
...
Scenario: Ops user views the extra details of a policy

When I navigate to the 'Policy Extras' of a policy
  Then I should be on the 'Policy Extras page'
  And I should see extra information for the policy
