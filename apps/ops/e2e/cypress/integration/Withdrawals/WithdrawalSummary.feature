...
Scenario: Ops user navigates to Withdrawal Summary page 
  ...
  When I enter Effective date "07/15/2024" on Amount page
  ...
  And I should verify Summary details
  And I should verify Taxes details on Summary page