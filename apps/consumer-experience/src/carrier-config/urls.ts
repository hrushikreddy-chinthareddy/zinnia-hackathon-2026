...
export const CARRIER_REDIRECT_URLS = {
  [CompanyName.FARMERS]: {
    ...
    COMMUNICATION_PREFERENCES: `${CARRIER_REDIRECT_BASE_URLS[CompanyName.FARMERS]}/${FarmersURLS.MY_PROFILE}?isZinniaSso=true`,
    MANAGE_CHANGES: `${CARRIER_REDIRECT_BASE_URLS[CompanyName.FARMERS]}/${FarmersURLS.MY_PROFILE}?isZinniaSso=true`,
  },
};
