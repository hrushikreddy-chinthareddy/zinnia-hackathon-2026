...
export const PolicyStatusAlertBanner = async ({
  ...
  switch (data?.policyStatus) {
    case PolicyStatus.PENDINGLAPSE:
      statusContent = {
        text: `Your policy is about to lapse, leaving you uninsured. Pay at least ${formatUSDollars(data.minimumPaymentDue)} by ${standardDateMonthYear(data.minimumPaymentDueDate)} to get back on track. Call ${EVERLY_CONTACT_PHONE_NUMBER} to make a payment.`,
