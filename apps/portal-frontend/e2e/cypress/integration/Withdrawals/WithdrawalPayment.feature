...
Scenario: Ops user navigates to Withdrawal Payment page deselecting Bank details
  ...
  When I deselect a payment account 'JPMORGAN CHASE' on Payment page
...
Scenario: Ops user navigates to Withdrawal Payment page 
