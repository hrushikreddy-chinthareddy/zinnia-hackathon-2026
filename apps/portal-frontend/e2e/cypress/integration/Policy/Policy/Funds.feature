Feature: Ops user views the extra details of a policy
...
Scenario: Ops user views the funds details of a policy

When I navigate to the 'Funds' of a policy
  Then I should be on the 'Funds page'
  And I should see the detailed fund information of the policy
