### Team has decided to have a temporary fix to turn off confirm page feature file to avoid known failures from confirm page due to capped 1000 request limit for test policies
...
# Scenario: Ops user navigates to Manage AutoPay Confirmation page
...
#   Then I click on Policy on a Policy card
...
#   And I should verify New autopay details on Summary page
