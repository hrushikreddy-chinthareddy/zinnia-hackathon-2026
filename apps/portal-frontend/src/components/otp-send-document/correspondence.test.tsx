...
describe('Correspondence component', () => {
    ...
    it('should render the component', () => {
        ...
        render(<Correspondence policy={mockPolicy} ctiCallNumber="123" correlationId="456" user={{}} />);
    ...
    it('should pre-populate the email for E-delivery role', async () => {
        ...
        const emailRadio = screen.getByRole('radio', { name: 'correspondence.email' }) as HTMLInputElement;
    ...
    it('should be able to update the state for fax on input', async () => {
        ...
        const faxRadio = screen.getByRole('radio', { name: 'correspondence.fax' }) as HTMLInputElement;
        ...
        // check radio fax selected
        expect(faxRadio.checked).toBe(true);
    ...
    it('should display validation for corelation id', async () => {
        ...
        render(<Correspondence policy={mockPolicy} ctiCallNumber="123" correlationId="" user={{}} />);
    ...
    it('should select email type default', async () => {
        ...
        expect(screen.getByRole('radio', { name: 'correspondence.email' })).toBeChecked();
    });
    ...
    it.skip('should display addresses on Mail type selection', async () => {
        ...
        const mailOption = screen.getByRole('radio', { name: 'correspondence.mail' }) as HTMLInputElement;
