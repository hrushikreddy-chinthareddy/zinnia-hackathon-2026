...
describe('Formparty component', () => {
    describe('FLIC Form', () => {
        it('should render empty formControls if parties object is empty', () => {
        ...
        it('should render formControls based on configuration configuration', () => {
            let setMethodArgs;
    ...
    describe('SBGC Form', () => {
        ...
        it('should render formControls based on configuration', () => {
            const { formPartyConfigs } = getSbgcConfig(t);
    ...
    describe('DLIC Withdrawal Form', () => {
        ...
        it('should render empty address formControls on address changed checkbox selection', () => {
            let setMethodArgs;
