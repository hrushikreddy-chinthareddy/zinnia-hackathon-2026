...
import { LineOfBusiness, Policy } from '@deps/models/policy/sor-policy';
...
const QuickLinks = ({ links, planCode, policyNumber, eligibilityCheck, isLoading, onOpenChange, policy }: QuickLinksProps) => {
