...
export type PartyInfo = {
    fields?: {
        address: PartyDataPoint<Address>;
    ...
    return (
        <li className="flex flex-col gap-1" {...rest}>
            ...
            <Typography variant={TypographyVariant.Caption}>
                <PiiWrapper>{owner.ssn}</PiiWrapper>
            </Typography>
            <div className="flex flex-row flex-wrap gap-1">
    ...
    return (
        <div className="flex w-full flex-col p-4 md:px-8" {...rest}>
            ...
            {owners.length ? (
                ...
                <NoPartiesStatus caseStatus={caseStatus} partyType="owner" className={`${listClasses} pt-0`} spinLoader={loadingPolicy} />
            )}
            {agents.length ? (
