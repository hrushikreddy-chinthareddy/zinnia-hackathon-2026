...
import { calculateAgeNumber, getDisplayAge } from '@deps/helpers/age.helper';
...
import { BASE_KEYS } from '../policy-details/policy-details.helper';
                ...
                <div>
                    ...
                    <p className="body-sm">
                        <PiiWrapper>
                            {getDisplayAge(
                                ageInYears,
                                t(`${BASE_KEYS.insured}oneYearOld`),
                                t(`${BASE_KEYS.insured}nYearsOld`, { n: ageInYears })
                            )}
                        </PiiWrapper>
                    </p>
                </div>
    ...
    const partyRoleTags = (
        <div className="mt-1 flex xs:flex-col md:flex-row md:items-center md:align-middle">
            ...
            {isStillInactive.interiorPeoplePageHeader ? (
                <TempNavInactive triggerClassName="mx-4" tooltipBody={isStillInactive.interiorPeoplePageHeader}>
