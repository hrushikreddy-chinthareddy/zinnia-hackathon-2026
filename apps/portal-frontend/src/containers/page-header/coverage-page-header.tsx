...
import { PolicyCoverage, DeathBenefit } from '@deps/models/policy/sor-policy';
...
const CoveragePageHeaderContainer = ({
    ...
    const coveragePageHeaderItems = {
        grossDeathBenefit: !(coverage?.cumulativeGrossDeathBenefitAmount == null)
            ? numberFormatify(coverage?.cumulativeGrossDeathBenefitAmount, currencyFormat)
            : DEFAULT_ERROR_STRING,
        netDeathBenefit: !(coverage?.netDeathBenefit == null)
            ? numberFormatify(coverage.netDeathBenefit, currencyFormat)
            : DEFAULT_ERROR_STRING,
        deathBenefitOption: toTitleCase(deathBenefit?.deathBenefitOption ?? DEFAULT_ERROR_STRING),
    };
