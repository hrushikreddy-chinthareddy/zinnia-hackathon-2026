...
import HistoryPageHeader from '@deps/containers/page-header/history-page-header';
import EventFeed from '@deps/containers/subpages/history-sub-page/event-feed/event-feed';
import SideSheetHistory from '@deps/containers/subpages/history-sub-page/side-sheet-history';
        ...
        <HistoryFiltersProvider>
            <div className="flex h-full flex-col items-start rounded bg-white">
                ...
                <div className="responsive-padding flex grow basis-[350px] flex-col items-start gap-4 self-stretch overflow-auto !pr-0 lg:flex-row lg:gap-8">
                    ...
                    <EventFeed isSideSheetOpen={isSideSheetOpen} />
                </div>
