...
import usesSbgcConfig from './sbgc-ssw-form-helper';
...
jest.mock('@deps/components/otp-withdrawal-form/ssw-program/ssw-form-program.helper', () => {
    const originalModule = jest.requireActual('@deps/components/otp-withdrawal-form/ssw-program/ssw-form-program.helper');
    return {
        ...originalModule,
