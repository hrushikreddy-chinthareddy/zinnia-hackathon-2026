...
const ContentContainer = ({ children, policy, openSideSheet }: ContentContainerProps) => {
    ...
    const containerClasses = clsx(
        'height-adjusted flex w-full flex-col overflow-auto py-4 pl-[52px] transition-[padding] duration-300 sm:pr-4 md:py-6 md:pr-6 lg:py-8 lg:pr-8 [&>div]:max-w-[1130px]',
        {
