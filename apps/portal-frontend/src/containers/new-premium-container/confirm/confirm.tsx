...
const Confirm = ({ policy }: ConfirmProps) => {
    ...
    if (submitFailed) {
        return (
            <ApiErrorCard
                leaveRoute={`/policies/${policy.product?.planCode}/${policy.policyNumber}/transactions/premiums`}
                submit={{
                    action: submit,
                        ...
                        <CardInfo
                            ...
                            secondaryCta={
                                <NavElement
                                    ...
                                    onClick={() =>
                                        router.push(`/policies/${policy.product?.planCode}/${policy.policyNumber}/transactions/premiums`)
                                    }
