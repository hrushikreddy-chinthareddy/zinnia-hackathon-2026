...
export const getPartyFullName = (partyInfo: PolicyAllOfPartiesItem | undefined): string => {
    ...
    switch (partyType) {
        case PartyType.INDIVIDUAL:
            return `${toTitleCase(partyInfo?.firstName)} ${toTitleCase(partyInfo?.middleName)} ${toTitleCase(
                partyInfo?.lastName
...
export const getRiskClass = (riskClass: RiskClass | undefined, t: TFunction): string | undefined => {
    switch (riskClass) {
