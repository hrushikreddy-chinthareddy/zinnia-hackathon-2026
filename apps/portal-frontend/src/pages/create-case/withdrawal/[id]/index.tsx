...
export const getServerSideProps = withPageAuthRequired({
    getServerSideProps: async (context: GetServerSidePropsContext) => {
        ...
        if (
            [Carrier.NASU, Carrier.RSLN, Carrier.GDMN].includes(clientId.toUpperCase() as Carrier) &&
            !isFormFeatureEnabled(ProcessType.WITHDRAWAL, clientId, featureFlagDecisions)
        ) {
