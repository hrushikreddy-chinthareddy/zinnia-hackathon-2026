...
const CaseCreate = ({ featureFlagDecisions }: CaseCreateProps) => {
    ...
    async function createCase(): Promise<void> {
        ...
        if (docType === docTypes[CaseType.AddressChange]) {
            await handleSearch();
            return;
        }
            ...
            <div className="flex flex-col">
                {!shouldShowNewExperience ? (
                    ...
                    <>
                        ...
                        <Typography variant={TypographyVariant.H1} className="font-primary text-xl">
                            {t('site.navLinks.transactionOpsSuite.text')}
                        </Typography>
